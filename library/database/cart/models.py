"""Модуль моделей таблиц для работа с БД OpenCart"""
import dataclasses
...
class Base(DeclarativeBase):
    """Базовый класс для объявления моделей таблиц БД OpenCart"""


@dataclasses.dataclass
class Customer(Base):
    """Класс представления таблицы 'oc_customer'"""

    # pylint: disable=too-many-instance-attributes
    # здоровенная таблица oc_customer
    ...
    customer_group_id: Mapped[int] = mapped_column(
        'customer_group_id', Integer, nullable=False)
    store_id: Mapped[int] = mapped_column(
        'store_id', Integer, default=0, nullable=False)
    language_id: Mapped[int] = mapped_column(
        'language_id', Integer, nullable=False)
    firstname: Mapped[str] = mapped_column(
        'firstname', String(32), nullable=False)
    lastname: Mapped[str] = mapped_column(
        'lastname', String(32), nullable=False)
    email: Mapped[str] = mapped_column(
        'email', String(96), nullable=False, index=True)
    telephone: Mapped[str] = mapped_column(
        'telephone', String(32), nullable=False)
    password: Mapped[str] = mapped_column(
        'password', String(255), nullable=False)
    custom_field: Mapped[str] = mapped_column(
        'custom_field', Text, nullable=False)
    newsletter: Mapped[bool] = mapped_column(
        'newsletter', Boolean, nullable=False)
    ...
    commenter: Mapped[bool] = mapped_column(
        'commenter', Boolean, nullable=False)
    ...
    date_added: Mapped[datetime] = mapped_column(
        'date_added', DateTime, nullable=False)
...
@dataclasses.dataclass
class Cart(Base):
    """Класс представления таблицы 'oc_cart'"""

    # pylint: disable=too-many-instance-attributes
    # здоровенная таблица oc_cart
...
@dataclasses.dataclass
class Product(Base):
    """Класс представления таблицы 'oc_product'"""

    # pylint: disable=too-many-instance-attributes
    # здоровенная таблица oc_product
    ...
    master_id: Mapped[int] = mapped_column(
        'master_id', Integer, nullable=False, default=0)
    ...
    location: Mapped[str] = mapped_column(
        'location', String(128), nullable=False)
    variant: Mapped[str] = mapped_column(
        'variant', Text, nullable=False, default='')
    override: Mapped[str] = mapped_column(
        'override', Text, nullable=False, default='')
    quantity: Mapped[int] = mapped_column(
        'quantity', Integer, nullable=False, default=0)
    stock_status_id: Mapped[int] = mapped_column(
        'stock_status_id', Integer, nullable=False)
    image: Mapped[str] = mapped_column('image', String(255), nullable=False)
    manufacturer_id: Mapped[int] = mapped_column(
        'manufacturer_id', Integer, nullable=False)
    shipping: Mapped[bool] = mapped_column(
        'shipping', Boolean, nullable=False, default=True)
    price: Mapped[Decimal] = mapped_column('price', Numeric(15, 4), nullable=False,
                                           default=0)
    points: Mapped[int] = mapped_column(
        'points', Integer, nullable=False, default=0)
    tax_class_id: Mapped[int] = mapped_column(
        'tax_class_id', Integer, nullable=False)
    date_available: Mapped[datetime] = mapped_column(
        'date_available', DateTime, nullable=False)
    ...
    length_class_id: Mapped[int] = mapped_column('length_class_id', Integer, nullable=False,
                                                 default=0)
    subtract: Mapped[bool] = mapped_column(
        'subtract', Boolean, nullable=False, default=True)
    minimum: Mapped[int] = mapped_column(
        'minimum', Integer, nullable=False, default=1)
    rating: Mapped[bool] = mapped_column('rating', Boolean, nullable=False)
    sort_order: Mapped[int] = mapped_column(
        'sort_order', Integer, nullable=False, default=0)
    status: Mapped[bool] = mapped_column(
        'status', Boolean, nullable=False, default=False)
    date_added: Mapped[datetime] = mapped_column(
        'date_added', DateTime, nullable=False)
    date_modified: Mapped[datetime] = mapped_column(
        'date_modified', DateTime, nullable=False)
...
class ProductDescription(Base):
    """Класс представления таблицы 'oc_product_description'"""

    # pylint: disable=too-many-instance-attributes
    # здоровенная таблица oc_product_description
    ...
    meta_title: Mapped[str] = mapped_column(
        'meta_title', String(255), nullable=False, index=True)
